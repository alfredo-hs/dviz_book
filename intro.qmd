...
```{r mondrian-fig, echo=TRUE, fig.align='center', fig.asp=.75, message=FALSE, warning=FALSE, out.width='80%', paged.print=FALSE}
#| fig-cap: "An *attempt* at a Mondrian using `ggplot2`"
#| code-fold: true
